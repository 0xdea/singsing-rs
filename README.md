...
[![](https://img.shields.io/crates/v/zucchini-scanner?style=flat&color=red&label=zucchini-scanner)](https://crates.io/crates/zucchini-scanner)
...
Install the latest release of the scanner from [crates.io](https://crates.io/crates/zucchini-scanner) (this installs the `zucchini` binary):
...
It belongs to the broader family of asynchronous scanners that includes [`scanrand`](https://github.com/krisnova/paketto), [`unicornscan`](https://github.com/robertelee78/unicornscan), [`zmap`](https://github.com/zmap/zmap), and [`masscan`](https://github.com/robertdavidgraham/masscan).
